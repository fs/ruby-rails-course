...
* HTTP
  ...
  * ответ. имитация сервера через net-cap; nc -l 5000
    * codes
      ...
      * 5xx server error
  * features of HTTP:
    * different types of request. HEAD, GET, POST, PUT, DELETE
    * обход stateless - cookies. sessions

* HTML
  * версии. v4.0, xhtml 1.0, 5.0
  * css
  * поддержка разными браузерами, фичи разных браузеров.
  * основы.
